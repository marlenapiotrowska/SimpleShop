...
{
    Task<ErrorOr<Success>> HandleAsync(DeleteProductRequest request, CancellationToken cancellationToken);
}
...
{
    public async Task<ErrorOr<Success>> HandleAsync(DeleteProductRequest request, CancellationToken cancellationToken)
    {
