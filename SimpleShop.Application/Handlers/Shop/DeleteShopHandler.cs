...
namespace SimpleShop.Application.Handlers.Shop
{
    ...
    {
        Task<ErrorOr<Success>> Handle(DeleteShopRequest request, CancellationToken cancellationToken);
    }
    ...
    internal class DeleteShopHandler(
        ...
        : IDeleteShopHandler
    {
        public async Task<ErrorOr<Success>> Handle(DeleteShopRequest request, CancellationToken cancellationToken)
        {
